...
<div className=" h-[560px] w-[50%]  font-sans text-[22px] mr-[5%]">
  <div className="mb-5">
    <b className=" text-[#FA8907] text-6xl font-medium ml-[125px]">Our Mission</b>
  </div>

  “At “the taxi guru”, our mission is to give protected, dependable, and advantageous transportation arrangements in Seunk Mullanpur, New Chandigarh, and beyond.<br />
  <br />
   We are focused on guaranteeing the prosperity of our travelers by keeping an fleet of well-equipped vehicles driven by proficient and respectful drivers.<br />
   <br />
    Through straightforward valuing, and a devotion to consumer loyalty, we mean to reclassify the movement experience for people and families.
    <br />
    <br />
     At “the taxi guru”, we don’t simply drive; we prepare for consistent, charming excursions, making each ride with us a vital encounter.”<br />
</div>
