  ...
  return (
    <div>
      <div className="bg-gray-400 h-8">
        <p className=" font-black relative  left-4 top-1">About US</p>
      </div>
      <b className="text-orange-500 text-3xl relative top-6 left-9">
        Who We Are?
      </b>
      <div className=" h-62 w-96  relative top-9 left-7 font-sans font-semibold">
